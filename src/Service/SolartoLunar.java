...
public class SolartoLunar {
     ...
     * |----4位闰月|-------------13位1为30天，0为29天|
     * 转化为对应的二进制数
     * 后四位是闰月的月份  13位如果是1代表这个月有30天 如果是2这个月有29天
     */
    ...
    private static Solar SolarFromInt(long g) {
        ...
        Solar solar = new Solar((int) dd, (int) mm, (int) y);
        return solar;
    }
    ...
    /*public String[] Service.test(String year,String month,String day){
        ...
        solar.solarDay = Integer.parseInt(day);
        Lunar lunar = SolarToLunar(solar);
        String[] x = {String.valueOf(lunar.lunarYear),
                        String.valueOf(lunar.lunarMonth),
                        String.valueOf(lunar.lunarDay),
                        lunarYearToGanZhi(lunar.lunarYear)};
        return x;
    }*/
}
